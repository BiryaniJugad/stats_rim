    ...
    const JOB_SKILLS = {
        'Novice':    { label: 'Novice',    pts: 49, unlocked: [ { name: 'Basic Skill', cur: 0, max: 9,  type: 'active', img: 'n_basicSkills' }, { name: 'First Aid',  cur: 1, max: 1, type: 'quest' }, { name: 'Trick Dead', cur: 1, max: 1, type: 'quest' } ], locked: [] },
