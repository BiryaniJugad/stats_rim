...
const SKILL_DESCRIPTIONS = {
    ...
    'Decrease Agility': {
        ...
        requirements: {
            ...
            'Super Novice': 'Increase Agility Lv 1',
        },
        copyable: true,
        interruptible: true,
        relatedClass: 'Acolyte',
    ...
    'Angelus': {
        ...
        requiredFor: {
            'Priest': 'Kyrie Eleison (Lv 2)',
            'High Priest': 'Assumptio (Lv 1)',
        },
        copyable: true,
        interruptible: true,
        relatedClass: 'Acolyte',
        ...
        desc: 'Increases the DEF from VIT of all party members on screen by (5*SkillLV)%. Does not increase anything else that has to do with VIT at all.',
         tableRows: [
            ...
            { level: 4, desc: '120% VIT DEF' },
            { level: 5, desc: '125% VIT DEF' },
            { level: 6, desc: '130% VIT DEF' },
            { level: 7, desc: '135% VIT DEF' },
            { level: 8, desc: '140% VIT DEF' },
            { level: 9, desc: '145% VIT DEF' },
            { level: 10, desc: '150% VIT DEF' },
        ],
    },
    ...
    'Blessing': {
        ...
        requirements: {
            ...
            'Super Novice': 'Divine Protection Lv 5',
        },
        copyable: true,
        interruptible: true,
        relatedClass: 'Acolyte',
        relatedStatus: 'Blessing',
        desc: 'If used on Undead property or Demon family monsters, it halves their STR, DEX and INT, regardless of skill level.',
        notes: ['Skill does not affect players with Hovering active'],
        tableRows: [
            { level: 1, desc: '+1 STR, DEX & INT' },
            { level: 2, desc: '+2 STR, DEX & INT' },
            { level: 3, desc: '+3 STR, DEX & INT' },
            { level: 4, desc: '+4 STR, DEX & INT' },
            { level: 5, desc: '+5 STR, DEX & INT' },
            { level: 6, desc: '+6 STR, DEX & INT' },
            { level: 7, desc: '+7 STR, DEX & INT' },
            { level: 8, desc: '+8 STR, DEX & INT' },
            { level: 9, desc: '+9 STR, DEX & INT' },
            { level: 10, desc: '+10 STR, DEX & INT' },
        ],
    },
    ...
    'Cure': {
        ...
        requirements: {
            'Acolyte': 'Heal Lv 2',
            'Crusader': 'Faith Lv 5',
            'Super Novice': 'Heal Lv 2',
        },
        spCost: '15 SP',
        copyable: true,
        interruptible: true,
        relatedClass: 'Acolyte',
        desc: 'Cures Blind, Confusion and Silence (limitation: you can\'t cure yourself from Silence since you cant cast while Silenced).',
        notes: ['Cannot be used in Aldebaran Turbo Track.'],
    },
    ...
    'Enlarge Weight Limit': {
        ...
        requiredFor: {
            ...
            'Super Novice': 'Discount (Lv 3), Pushcart (Lv 5)',
        },
        copyable: false,
        interruptible: false,
        relatedClass: 'Merchant',
        desc: '	Increases maximum carrying capacity by 200*SkillLV.',
        tableRows: [
            { level: 1, desc: 'Weight capacity +200' },
            { level: 2, desc: 'Weight capacity +400' },
            { level: 3, desc: 'Weight capacity +600' },
            { level: 4, desc: 'Weight capacity +800' },
            { level: 5, desc: 'Weight capacity +1000' },
            { level: 6, desc: 'Weight capacity +1200' },
            { level: 7, desc: 'Weight capacity +1400' },
            { level: 8, desc: 'Weight capacity +1600' },
            { level: 9, desc: 'Weight capacity +1800' },
            { level: 10, desc: 'Weight capacity +2000' },
        ],
    },
    ...
    'Identify': {
        ...
        interruptible: false,
        relatedClass: 'Merchant',
        desc: 'Identifies an unidentified item. Unidentified item must be in inventory (not cart). A Magnifier duplicates the effect of this skill.',
    ...
    'Mammonite': {
        ...
        interruptible: false,
        relatedClass: 'Merchant',
        desc: 'Uses 100z*SkillLV to increase ATK to (100+50*SkillLV)% for the next attack.',
        tableRows: [
            { level: 1, desc: 'ATK 150%, 100Z spent' },
            { level: 2, desc: 'ATK 200%, 200Z spent' },
            { level: 3, desc: 'ATK 250%, 300Z spent' },
            { level: 4, desc: 'ATK 300%, 400Z spent' },
            { level: 5, desc: 'ATK 350%, 500Z spent' },
            { level: 6, desc: 'ATK 400%, 600Z spent' },
            { level: 7, desc: 'ATK 450%, 700Z spent' },
            { level: 8, desc: 'ATK 500%, 800Z spent' },
            { level: 9, desc: 'ATK 550%, 900Z spent' },
            { level: 10, desc: 'ATK 600%, 1000Z spent' },
        ],
    },
    ...
    'Cart Revolution': {
        ...
        interruptible: false,
        relatedClass: 'Merchant',
        desc: '	Does ATK*150% neutral-property damage to 3x3 area around your target. Enemies hit by the attack are pushed back 2 cells. The appearance is just like Magnum Break, except you also see your cart go flying over your head and hitting the ground in front of you.',
        notes: ['Skill is usable while in a Mado'],
    },
    ...
    'Change Cart': {
        ...
        interruptible: false,
        relatedClass: 'Merchant',
        desc: 'Lets you change the appearance of your cart. A "for fun" skill, but because the appearances you can pick is restricted by the characters base level, you can tell a high level merchant or blacksmith just by looking at their cart.',
        notes: ['Skill is usable while in a Mado'],
    },
    ...
    'Loud Exclamation': {
        ...
        interruptible: false,
        relatedClass: 'Merchant',
        desc: 'Skill is usable while in a Mado.',
    },
    ...
    'Cart Decoration': {
        ...
        interruptible: false,
        relatedClass: 'Merchant',
        desc: 'Change Pushcart appearance.',
        notes: ['Skill is usable while in a Mado.'],
        effect: () => [],
    },
    ...
    'Discount': {
        ...
        requirements: {
            ...
            'Super Novice': 'Enlarge Weight Limit Lv 3',
        },
        requiredFor: {
        ...
        interruptible: false,
        relatedClass: 'Merchant',
        desc: 'Allows buying items at reduced prices from NPC shops. Deals, vending shops, and chat-selling NPCs (e.g. Upgrade stone NPC) are not affected. The final price is always rounded down and has a minimum value of 1z..',
    },
    ...
    'Overcharge': {
        ...
        desc: 'Increases the sell price of items at NPC shops.',
         tableRows: [
            ...
            { level: 4, desc: '-13% Price' },
            { level: 5, desc: '-15% Price' },
            { level: 6, desc: '-17% Price' },
            { level: 7, desc: '-19% Price' },
            { level: 8, desc: '-21% Price' },
            { level: 9, desc: '-23% Price' },
            { level: 10, desc: '-24% Price' },
        ],
    },
    ...
    'Pushcart': {
        ...
        desc: 'The pushcart can hold 8000 Weight and a maximum of 100 distinct items(some items stack, so count as only 1 distinct item). Pushcarts must be bought from a Kafra Employee and there is at least one present in every town and some may be found in other locations.',
         tableRows: [
            ...
            { level: 4, desc: '70% Movement Speed' },
            { level: 5, desc: '75% Movement Speed' },
            { level: 6, desc: '80% Movement Speed' },
            { level: 7, desc: '85% Movement Speed' },
            { level: 8, desc: '90% Movement Speed' },
            { level: 9, desc: '95% Movement Speed' },
            { level: 10, desc: '100% Movement Speed' },
        ],
    },
    ...
    'Vending': {
        ...
        requirements: {
            ...
            'Super Novice': 'Pushcart Lv 3',
        },
        requiredFor: {
            'Merchant': 'Buying Store (Lv 1)',
            'Super Novice': 'Buying Store (Lv 1)',
        },
        spCost: '30 SP',
        copyable: false,
        interruptible: false,
        ...
        notes: ['Skill is usable while in a Mado'],
           tableRows: [
            ...
            { level: 4, desc: '6 Items' },
            { level: 5, desc: '7 Items' },
            { level: 6, desc: '8 Items' },
            { level: 7, desc: '9 Items' },
            { level: 8, desc: '10 Items' },
            { level: 9, desc: '11 Items' },
            { level: 10, desc: '12 Items' },
        ],
    },
    ...
    'Buying Store': {
        ...
        requirements: {
            ...
            'Super Novice': 'Vending Lv 1',
        },
        spCost: '1 SP',
        copyable: false,
        interruptible: false,
        relatedClass: 'Merchant',
        desc: 'Enables the ability to open a purchase stall to buy various kinds of items. Must have atleast 1 item you are buying.',
    ...
    'Double Attack': {
        ...
        interruptible: false,
        relatedClass: 'Thief',
        desc: 'Gives chance to double swing a Dagger class weapon with a chance equal to (5*SkillLV)%, and adds +1 HIT per SkillLV (that only applies in double attacks). In the case of an Assassin wielding two Dagger class weapons, it applies to the right-hand weapon only.',
        tableRows: [
            { level: 1, desc: '5% Chance, +1 HIT, +3% Katar DMG' },
            { level: 2, desc: '10% Chance, +2 HIT, +5% Katar DMG' },
            { level: 3, desc: '15% Chance, +3 HIT, +7% Katar DMG' },
            { level: 4, desc: '20% Chance, +4 HIT, +9% Katar DMG' },
            { level: 5, desc: '25% Chance, +5 HIT, +11% Katar DMG' },
            { level: 6, desc: '30% Chance, +6 HIT, +13% Katar DMG' },
            { level: 7, desc: '35% Chance, +7 HIT, +15% Katar DMG' },
            { level: 8, desc: '40% Chance, +8 HIT, +17% Katar DMG' },
            { level: 9, desc: '45% Chance, +9 HIT, +19% Katar DMG' },
            { level: 10, desc: '50% Chance, +10 HIT, +21% Katar DMG' },
        ],
    },
    ...
    'Increase Dodge': {
        ...
        desc: '	Increases Flee Rate by +3*SkillLV. This skill boosts the walking speed for Assassins by 1% per SkillLV and gives an additional +1 Flee Rate per SkillLV when you are an Assassin or Rogue.',
          tableRows: [
            ...
            { level: 4, desc: 'Flee Rate +12% (2nd class Flee Rate +16%)' },
            { level: 5, desc: 'Flee Rate +15% (2nd class Flee Rate +20%)' },
            { level: 6, desc: 'Flee Rate +18% (2nd class Flee Rate +24%)' },
            { level: 7, desc: 'Flee Rate +21% (2nd class Flee Rate +28%)' },
            { level: 8, desc: 'Flee Rate +24% (2nd class Flee Rate +32%)' },
            { level: 9, desc: 'Flee Rate +27% (2nd class Flee Rate +36%)' },
            { level: 10, desc: 'Flee Rate +30% (2nd class Flee Rate +40%)' },
        ],
    },
    ...
    'Steal': {
        ...
        requiredFor: {
            'Thief': 'Hiding (Lv 5)',
            'Rogue': 'Snatcher (Gank) (Lv 1)',
            'Super Novice': 'Hiding (Lv 5)',
        },
        copyable: true,
        interruptible: false,
        relatedClass: 'Thief',
        desc: 'where DropRatio is the percent chance of a particular item being dropped. If the result of the steal check is lower than the AdjustedDropRatio for an item, then it is possible that item will be stolen.',
          tableRows: [
            ...
            { level: 4, desc: 'Success Chance 28%' },
            { level: 5, desc: 'Success Chance 34%' },
            { level: 6, desc: 'Success Chance 40%' },
            { level: 7, desc: 'Success Chance 46%' },
            { level: 8, desc: 'Success Chance 52%' },
            { level: 9, desc: 'Success Chance 58%' },
            { level: 10, desc: 'Success Chance 64%' },
        ],
    },
    ...
    'Envenom': {
        ...
        requiredFor: {
            'Thief': 'Detoxify (Lv 3)',
            'Assassin': 'Enchant Poison (Lv 1)',
            'Super Novice': 'Detoxify (Lv 3)',
            'Assassin Cross': 'Soul Destroyer (Lv 5), Create Deadly Poison (Lv 10)',
        },
        copyable: true,
        interruptible: false,
        relatedClass: 'Thief',
        relatedStatus: 'Poison',
        desc: 'An attack that adds 15*SkillLV to your ATK (unmodified by Armor and VIT Def) to your normal damage. This bonus damage is always inflicted, whether your character lands a normal hit or not.',
        tableRows: [
            { level: 1, desc: '+15 ATK' },
            { level: 2, desc: '+30 ATK' },
            { level: 3, desc: '+45 ATK' },
            ...
            { level: 5, desc: '+75 ATK' },
            { level: 6, desc: '+90 ATK' },
            { level: 7, desc: '+105 ATK' },
            { level: 8, desc: '+120 ATK' },
            { level: 9, desc: '+135 ATK' },
            { level: 10, desc: '+150 ATK' },
        ],
    },
    ...
    'Sprinkle Sand': {
        ...
        relatedClass: 'Thief',
        relatedStatus: 'Blind',
        desc: 'An attack with 130% normal ATK and with a 20% chance to cause blind effect. Although it has no Cast Time or Cool Down it cant be spamed.',
        nptes: ['Skill ignores casters % damage cards'],
    },
    ...
    'Pick Stone': {
        ...
        interruptible: false,
        relatedClass: 'Thief',
        desc: 'Adds one Stone item to your inventory. Will not work if you are overweight (more than 50% of total weight capacity).',
    },
    ...
    'Throw Stone': {
        ...
        relatedClass: 'Thief',
        relatedStatus: 'Stun',
        desc: 'An attack that always does 50 points of damage (but does not ignore damage reduction cards) and has a 3% chance of causing the stun effect on the target. Consumes one stone per use. Useful for luring monsters link monsters away from a pack and other such sneaky thief-like tricks.',
        notes: ['Skill ignores targets flee'],
    },
    ...
    'Hiding': {
        ...
        notes: ['Skill is affected by Kagehumi (Shadow Trampling))'],
         tableRows: [
            ...
            { level: 4, desc: '120 Seconds, SP 1 / 8sec' },
            { level: 5, desc: '150 Seconds, SP 1 / 9sec' },
            { level: 6, desc: '180 Seconds, SP 1 / 10sec' },
            { level: 7, desc: '210 Seconds, SP 1 / 11sec' },
            { level: 8, desc: '240 Seconds, SP 1 / 12sec' },
            { level: 9, desc: '270 Seconds, SP 1 / 13sec' },
            { level: 10, desc: '300 Seconds, SP 1 / 14sec' },
        ],
    },
    ...
    'Detoxify': {
        ...
        interruptible: true,
        relatedClass: 'Thief',
        desc: 'Cures poison status on target.',
    },
}
