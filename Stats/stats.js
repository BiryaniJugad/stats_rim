    ...
    const character = {
        baseLevel: 1,
        job: null, // swordsman, mage, archer etc
    ...
    function getFinalStats(character) {
        const jobBonus = jobBonuses[character.job] || {};
    
        return {
            str: character.stats.str + (jobBonus.str || 0),
            agi: character.stats.agi + (jobBonus.agi || 0),
            vit: character.stats.vit + (jobBonus.vit || 0),
            int: character.stats.int + (jobBonus.int || 0),
            dex: character.stats.dex + (jobBonus.dex || 0),
            luk: character.stats.luk + (jobBonus.luk || 0)
        };
    }
