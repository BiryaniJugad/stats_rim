...
function initializeElements() {
    // Updated selectors to match new grid class names
    const derivedCol = document.querySelector(".col-info");
    ...
    // Updated: was .column:first-child, now .col-stats
    const statRows = document.querySelectorAll(".col-stats .table-row");
    elements.statRows = {
        str: statRows[0], agi: statRows[1], vit: statRows[2],
        int: statRows[3], dex: statRows[4], luk: statRows[5]
    };

    // Updated: was .column:nth-child(2), now .col-pts
    elements.ptsReqDisplays = document.querySelectorAll(".col-pts .table-row .value");
}
